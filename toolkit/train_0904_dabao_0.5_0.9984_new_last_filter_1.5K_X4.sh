...
EXP_NAME=final2_1e3_2e5_1.5K_X4_huan
PRETRAIN_DATASET=../input/pretrain_stage_1/0904_dabao_0.5_0.9984_new_last_filter_1.5K_X4.jsonl
...
# /data/cjk/project/wjc/dj_synth_challenge/toolkit/training/data/finetuning_stage_1/mgm_instruction_stage_21.json
deepspeed --include localhost:$gpu_vis --master_port $master_port $SCRIPT_DIR/training/mgm/train/train_mem.py \
    --deepspeed $SCRIPT_DIR/training/scripts/zero2_offload.json \
    --model_name_or_path $CKPT_STAGE_1 \
    --version gemma \
