...
EXP_NAME=final_not_pre_source_fintune_2e-7_2
...
# CKPT_STAGE_1=../output/training_dirs/MGM-2B-Finetune-0904_mgm_pretrain_stage_1_matching_recall_240k_100_2
...
deepspeed --include localhost:$gpu_vis --master_port $master_port $SCRIPT_DIR/training/mgm/train/train_mem.py \
    ...
    --model_name_or_path $CKPT_STAGE_1 \
    --version gemma \
    --data_path $SCRIPT_DIR/training/data/finetuning_stage_1/mgm_instruction_stage_21.json \
