...
EXP_NAME=final_not_pre_1e6_7.5e7_CkPT
PRETRAIN_DATASET=../input/pretrain_stage_2/mgm_pretrain_stage_2.jsonl
PRETRAIN_DATASET_IMAGE_PATH=../input/pretrain_stage_2

# Checkpoint of Stage 1. Replace with your checkpoint dir in stage 1
CKPT_STAGE_1=$SCRIPT_DIR/training/model_zoo/LLM/gemma/gemma-2b-it
# training args
# pretraining
...
ORIGINAL_DATASET_ALL=$SCRIPT_DIR/../input/pretrain_stage_2/stage_2.json
...
MAX_SAMPLE_NUM=5000
SAMPLED_PRETRAIN_DATASET=$PRETRAIN_DATASET-5k.jsonl
...
# train model
PRETRAIN_NAME=MGM-2B-Pretrain-0904_mgm_pretrain_stage_1_matching_recall_240k_100_2
...
# deepspeed --include localhost:$gpu_vis --master_port $master_port $SCRIPT_DIR/training/mgm/train/train_mem.py \
#     --deepspeed $SCRIPT_DIR/training/scripts/zero2_offload.json \
#     --model_name_or_path $CKPT_STAGE_1 \
#     --version gemma \
...
# training/data/finetuning_stage_1/mgm_instruction_stage_1.json
deepspeed --include localhost:$gpu_vis --master_port $master_port $SCRIPT_DIR/training/mgm/train/train_mem.py \
    --deepspeed $SCRIPT_DIR/training/scripts/zero2_offload.json \
    --model_name_or_path $CKPT_STAGE_1 \
    --version gemma \
    --data_path $SCRIPT_DIR/training/data/finetuning_stage_2/mgm_instruction_stage_2.json \
    --image_folder $SCRIPT_DIR/training/data/finetuning_stage_2 \
    --vision_tower $SCRIPT_DIR/training/model_zoo/OpenAI/clip-vit-large-patch14-336 \
    --vision_tower_aux $SCRIPT_DIR/training/model_zoo/OpenAI/openclip-convnext-large-d-320-laion2B-s29B-b131K-ft-soup \
