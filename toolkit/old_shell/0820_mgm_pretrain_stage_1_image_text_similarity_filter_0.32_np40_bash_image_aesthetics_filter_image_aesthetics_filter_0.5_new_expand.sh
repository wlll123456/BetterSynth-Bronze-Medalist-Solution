...
# PASSWORD="c123456"
# echo "$PASSWORD" | sudo -S chmod -r 777 /data/cjk/project/wjc/dj_synth_challenge


EXP_NAME=0820_mgm_pretrain_stage_1_image_text_similarity_filter_0.32_np40_bash_image_aesthetics_filter_image_aesthetics_filter_0.5_new_expand
PRETRAIN_DATASET=../input/pretrain_stage_1/0820_mgm_pretrain_stage_1_image_text_similarity_filter_0.32_np40_bash_image_aesthetics_filter_image_aesthetics_filter_0.5_new_expand.jsonl
