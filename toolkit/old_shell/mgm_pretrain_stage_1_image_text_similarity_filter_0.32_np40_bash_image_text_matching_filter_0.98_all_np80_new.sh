...
EXP_NAME=default_mgm_pretrain_stage_1_image_text_similarity_filter_0.32_np40_bash_image_text_matching_filter_0.98_all_np80_new
PRETRAIN_DATASET=../input/pretrain_stage_1/mgm_pretrain_stage_1_image_text_similarity_filter_0.32_np40_bash_image_text_matching_filter_0.98_all_np80_new.jsonl
...
# --include localhost:$gpu_vis --master_port $master_port
