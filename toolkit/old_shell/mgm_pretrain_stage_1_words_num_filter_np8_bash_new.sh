...
EXP_NAME=default_mgm_pretrain_stage_1_words_num_filter_np8_bash_new
PRETRAIN_DATASET=../input/pretrain_stage_1/mgm_pretrain_stage_1_words_num_filter_np8_bash_new.jsonl
