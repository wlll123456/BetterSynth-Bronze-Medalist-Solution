...
EXP_NAME=default_mgm_pretrain_stage_1_image_watermark_filter_np8_bash_new_image_captioning_mapper_new
PRETRAIN_DATASET=../input/pretrain_stage_1/mgm_pretrain_stage_1_image_watermark_filter_np8_bash_new_image_captioning_mapper_new.jsonl
